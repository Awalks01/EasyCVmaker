...
<body>
    ...
    <form class="needs-validation" novalidate action="/app/create" method="post" enctype="multipart/form-data">
        <div id="app">
                                        ...
                                        <div class="form__form-group">
                                            <div class="form__form-row col-1">
                                                <div class="form__form-row--avatar">
                                                    <div class="form__form-row--avatar--label">
                                                        <input class="file-upload-input" type='file' onchange="readURL(this);" accept="image/*" id="avatar" name="avatar" required />
                                                ...
                                                <div class="form__form-row--avatar-right">
                                                    <div class="form-element col-1" name="position-firstName"><label class="">Nama depan*</label>
                                                        <input type="text" tabindex="" class="data-hj-whitelist form-control" autocomplete="off" name="firstName" value="" required>
                                                        <div class="invalid-feedback" style="font-size: 8px;">
                                                            Harus diisi
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-element col-1" name="position-lastName"><label class="">Nama belakang*</label>
                                                        <input type="text" tabindex="" class="data-hj-whitelist form-control" autocomplete="off" name="lastName" value="" required>
                                                        <div class="invalid-feedback" style="font-size: 8px;">
                                                            Harus diisi
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="form__form-row col-1">
                                                <div class="form-element col-2" name="position-email"><label class="">Alamat email*</label>
                                                    <input type="text" tabindex="" class="data-hj-whitelist form-control" autocomplete="off" name="email" value="" required>
                                                    <div class="invalid-feedback" style="font-size: 8px;">
                                                        Harus diisi
                                                    </div>
                                                </div>
